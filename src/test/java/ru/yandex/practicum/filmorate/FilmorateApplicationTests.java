...
@ContextConfiguration(classes = {UserDbRepository.class, UserRowMapper.class, UserExtractor.class,
		UserServiceImpl.class, UserController.class, UserValidatorImpl.class})
